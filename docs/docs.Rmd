...
date: "September 6th and 8th, 2022"
output:
...
.center[
```{r 4 plots in a grid, fig.dim=c(10,5.5), message=FALSE, out.extra='style="background-color: #ADB3B8; padding:5px"'}
...
- BUA 455 will use one README file format
   ...
   - [Empty README file template](https://drive.google.com/file/d/1RlJkuJWRsaqy7KWo718bNTl570T8n_hi/view?usp=sharing)

   - [Completed README file for Week 2 lectures](https://drive.google.com/file/d/1Q_vzUumn_ojAjNoATedtu4J78_fILwPs/view?usp=sharing)
...
**My Recommendation for Easy Collaboration:**
  ...
  - Each student should make their own R project and internal `code_data_output` folder for HW 2.
  
  - Email or share .Rmd file in a cloud drive
  
**GitHub** is used for collaboration and version control in more advanced courses and other disciplines.
...
[HW Assignment 2](https://blackboard.syracuse.edu/bbcswebdav/pid-8358216-dt-content-rid-95103694_1/xid-95103694_1) will give you experience with:
...
.panel[.panel-name[**First Steps: 0 - 3**]
...
.panel[.panel-name[**First Steps: 4**]

#### HW 2 - First Steps Continued
...
.panel[.panel-name[**First Steps: 5 - 6**]
...
.panel[.panel-name[**HW 2 - Part 1 - Provided R Code**]

```{r examining the diamonds data, eval = F}
...
### Week 2 In-class Exercises (TP L4 - Q2)
...
.panel[.panel-name[**HW 2 - Part 2 - Notes**]
...
.panel[.panel-name[**HW 2 - Part 2 - Steps to Follow**]
...
.panel[.panel-name[**HW 2 - Part 2 - Provided R Code**]
...
.panel[.panel-name[**HW 2 - Part 3 - Notes**]
...
.panel[.panel-name[**HW 2 - Part 3 - Steps to Follow**]
...
.panel[.panel-name[**HW 2 - Part 3 - Provided R Code**]
...
.panel[.panel-name[**HW 2 - Part 4 - Notes**]
...
.panel[.panel-name[**HW 2 - Part 4 - Steps to Follow**]
...
**`3.`** Use the example **`summary`** command code to summarize the factor variable **`clarity`** in the final **`my_diamonds3`** dataset.

**`4.`** Answer Blackboard Questions 5 and 6 to verify that you have completed these steps correctly.

]

.panel[.panel-name[** R Code - Part 1**]

```{r filtering data by value and summarizing part 1, eval = F}
...
.panel[.panel-name[**R Code - Part 2**]

```{r filtering data by value and summarizing part 2, eval = F}
...
.panel[.panel-name[**HW 2 - Part 5 - Notes**]
...
.panel[.panel-name[**Part 5 - Steps 1 - 4**]
#### Steps to Follow
...
.panel[.panel-name[**Part 5 - Steps 5 - 8**]
...
.panel[.panel-name[**Scatter Plots R code**]
...
.panel[.panel-name[**Boxplots R code**]
