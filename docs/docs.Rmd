...
```{r export final plot, eval=F}

sw_box4
ggsave("StarWars_BMI_Boxplot.png", width = 8, height = 6)
...
- BUA 455 will use one README file format
   ...
   - [Completed README file for Week 2 lectures](https://drive.google.com/file/d/1lu5Z4IQPLMSJSUSqevskrIQGmi0rQJkZ/view?usp=sharing)
